...
public class Task3 {
    ...
    public static void main(String[] args) {
        ...
        boolean useUpper = yesNoToBoolean(scanner.next());
        System.out.println();

        System.out.print("Include lowercase letters? (Yes/No): ");
        boolean useLower = yesNoToBoolean(scanner.next());
        System.out.println();

        System.out.print("Include numbers? (Yes/No): ");
        boolean useNumbers = yesNoToBoolean(scanner.next());
        System.out.println();

        System.out.print("Include special characters? (Yes/No): ");
        boolean useSpecial = yesNoToBoolean(scanner.next());
        System.out.println();
